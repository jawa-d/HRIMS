...
export const MENU_ITEMS = [
  ...
  { key: "barcode_export", labelKey: "nav.barcode_export", href: "barcode-export.html", icon: "qr-code" },
  { key: "official_books", labelKey: "nav.official_books", href: "official-books.html", icon: "file-signature" },
  { key: "insurance_parties", labelKey: "nav.insurance_parties", href: "insurance-parties.html", icon: "building-2" },
  { key: "insurance_docs", labelKey: "nav.insurance_docs", href: "insurance-docs.html", icon: "shield-check" },
